...
| `awg-mobile`, UDP/8443 | отдельный userspace mobile/AWG3+ с полным профилем AWG 3.1 | включается при первом mobile-клиенте |
...
| `mobile` (`mobile/AWG3+`) | полный профиль AWG 3.1 для AmneziaWG 5.0.1.5+ | `awg-mobile` userspace |
