...
> сессия установилась при активном режиме белых списков через цепочку
> **Yandex Cloud CDN → FRONT → ENTRY**, после чего сохранились штатные
...
| Режим белых списков на проверенной мобильной сети | подтверждённый резерв FRONT через Yandex Cloud CDN, [docs/front-relay.md](docs/front-relay.md) |
...
| Белые списки | в тестовой ветке подтверждена новая сессия Yandex Cloud CDN → FRONT → ENTRY с сохранением RU/EXIT-маршрутов |
